...
\title{\textbf{Entwicklung des Multisensorsystems BIMAGE.CapturePro-Backpack für die kinematische bildbasierte Innenraumaufnahme}}
\subtitle{GeoBeer \#17}
...
% project video
\begin{frame}
   \movie[showcontrols]{\includegraphics[width=1\textwidth]{./Abbildungen/CaptureProBackpack.JPG}}{./Abbildungen/pr_video_bimage_web.mp4}
\end{frame}

% evolution
\begin{frame}
\frametitle{Evolution}
% - Wagen: Sensorintegration
% - Rucksack 1: Datenakquisition, SLAM post-processing
% - Rucksack 2: Echtzeit-SLAM
\end{frame}
...
% - Bild Backpack aktuell HW-Beschriftung
% - Resultate: Orientierte Bilder (Näherungswerte, ca. 10 cm Genauigkeit), Punktwolke (Abfallprodukt SLAM)
\end{frame}
